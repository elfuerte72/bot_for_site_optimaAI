...
class RAGService:
    ...
    def __init__(self, settings: Settings):
        ...
        self.data_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "rag"))
        self.persist_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "rag_index"))
    ...
    def _initialize_rag_system(self) -> None:
        ...
        """
        try:
            self.logger.info(f"Инициализация RAG системы. Данные: {self.data_dir}, Индекс: {self.persist_dir}")
    ...
    async def get_rag_response(self, query: str, system_prompt: Optional[str] = None) -> str:
        """
