...
### API Ключи и Секреты
- [ ] **OpenAI API ключ** настроен и действителен
- [ ] **API ключи** не хранятся в коде (только в переменных окружения)
- [ ] **Секретные данные** не попадают в логи
- [ ] **Переменные окружения** защищены в продакшене
- [ ] **Backup** критичных ключей настроен

### Аутентификация и Авторизация
- [ ] **CORS** настроен только для нужных доменов (убрать "*")
- [ ] **Rate limiting** включён и настроен
- [ ] **API ключ** для аутентификации настроен (если нужен)
- [ ] **Валидация входных данных** работает корректно
- [ ] **Санитизация** пользовательского ввода включена
